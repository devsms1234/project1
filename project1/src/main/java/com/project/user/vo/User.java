...
public class User {
	...
	private LocalDateTime user_delete_date;
	...
	public User(int user_no, String user_id, String user_pw, String user_birth, String user_name, String user_address,
			...
			LocalDateTime user_date, LocalDateTime user_delete_date, String user_delete, int user_point) {
		super();
	...
	public LocalDateTime getUser_delete_date() {
	...
	public void setUser_delete_date(LocalDateTime user_delete_date) {
		this.user_delete_date = user_delete_date;
	}
	...
	public String toString() {
		return user_no +  user_id  + user_pw 
				+ user_birth  + user_name +  user_address 
				+ user_address_detail  + user_email + user_mobile 
				+ user_phone  + user_date + user_delete_date 
				+ user_delete  + user_point ;
	}
