        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">판매량 확인</h3>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <%@page import="com.gn.product_admin.vo.Product_admin, java.util.*" %>
                            <%	
                            	List<Product_admin> list = (List<Product_admin>)request.getAttribute("resultListSellCount");
                            	if(!list.isEmpty()){
    							for(int i = 0; i < list.size(); i++){%>
                            		<tr>
                            			...
                            			<td><%=list.get(i).getProd_sellCount() %>개</td>
                            			<td><%=list.get(i).getProd_sellCount() * list.get(i).getProd_price()%>원</td>
