        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">상품 수정 및 삭제</h3>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <%@page import="com.gn.product_admin.vo.Product_admin, java.util.*" %>
                            <%
                            	List<Product_admin> list = (List<Product_admin>)request.getAttribute("resultListUpdate");
                            	if(!list.isEmpty()){
                            	for(int i = 0; i < list.size(); i++){%>
                            		<tr>
                            			...
                            			<td><input type="button" class="btn btn-success" value="수정" onclick="productUpdateForm(<%= list.get(i).getProd_no() %>);"></td>
                            			<td><input type="button" class="btn btn-danger" value="삭제" onclick="productDeleteForm(<%= list.get(i).getProd_no() %>);"></td>
                            			<input type="hidden" id="product_no" name="product_no" value="<%= list.get(i).getProd_no()%>">       		
                            			<script>
                            			function productUpdateForm(productNo){
                            				let url = '/product_admin/product_update?product_no=' + productNo;
                            		        open(url, '_self');
                            			}
                            			function productDeleteForm(productNo){
                            				var result = confirm("정말로 삭제하시겠습니까?");
                            				if(result){
                            					let url = '/product_admin/product_deleteEnd?product_no=' + productNo;
                            					open(url, '_self');
                            				}else{
                            					alert("삭제를 취소합니다.");
                            				}
