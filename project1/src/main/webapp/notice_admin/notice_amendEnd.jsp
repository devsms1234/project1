        ...
        <div class="main-header">
          <div class="main-header-logo">
            ...
            <div class="page-header">
              <h3 class="fw-bold mb-3">게시판 등록</h3>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">게시판 정보 수정</div>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                          ...
                          <%@page import="com.gn.notice.vo.Notice, java.util.*" %>
                       	  <% Notice notice = (Notice)request.getAttribute("noticeInfo"); %>
                          <form action="/notice/amendEnd" name="notice_update_form" method="post" enctype="multipart/form-data">
                          <input type="hidden" name="notice_no" value="<%=notice.getNotice_no() %>">
                          <label for="notice_title">게시판 제목</label>
                          <input type="text" class="form-control" value="<%=notice.getNotice_title() %>"
              			   id="notice_title" name="notice_title" />
                  
                       	  <br>
                          <label for="notice_info">게시판 내용</label>
                          <textarea class="form-control" id="notice_info" 
                          name="notice_info" 
                          rows="5"><%=notice.getNotice_content() %></textarea><br>
                        
                         <label for="notice_img">등록된 이미지 : <%=notice.getNotice_img_enroll() %></label><br>
                     	 <input type="file" class="form-control-file" id="notice_img" name="notice_img" accept=".png,.jpg,.jpeg" /><br>
                         <input type="button" class="btn btn-success" value="확인" onclick="notice_updateBtn();">
                         <input type="reset" class="btn btn-danger" value="비우기">
                    	 </form>
				      	 <script type="text/javascript">
				       	  	function notice_updateBtn(){
				          	var result = confirm("수정하시겠습니까?");
				          	if(result){
				          	var form = document.notice_update_form;
				          	form.submit();
				          	}
				       	}
				    	</script>
