                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <%@ page import="com.gn.shop_user.vo.Inquiry, java.util.*" %>
                            <%
                            	List<Inquiry> list = (List<Inquiry>)request.getAttribute("adminInquiryList");
                            	if(!list.isEmpty()){
    							for(int i = 0; i < list.size(); i++){%>
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="/inquiry_admin/inquiry_adminInquiry?inquiry_no=<%=list.get(i).getInquiry_no() %>"><%=list.get(i).getInquiry_no() %></a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="/inquiry_admin/inquiry_adminInquiry?inquiry_no=<%=list.get(i).getInquiry_no() %>"><%=list.get(i).getInquiry_title() %></a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="/inquiry_admin/inquiry_adminInquiry?inquiry_no=<%=list.get(i).getInquiry_no() %>"><%=list.get(i).getWriter_name() %></a>
                                    </td>
                                    <td class="name-pr">
                                    	<a herf="/inquiry_admin/inquiry_adminInquiry?inquiry_no=<%=list.get(i).getInquiry_no() %>"><%=list.get(i).getInquiry_reg_date() %></a>
                                    </td>
