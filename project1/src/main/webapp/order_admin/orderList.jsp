                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        com.gn.order_admin.vo.Buy, com.gn.order_admin.vo.Shiplist,java.util.*" %>
                            <%
                            	List<Map<String, Object>> list = (List<Map<String, Object>>)request.getAttribute("resultListOrder");
                            	for(int i = 0; i < list.size(); i++){%>
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="/order_admin/orderInfo?order_no=<%= list.get(i).get("주문번호") %>"><%= list.get(i).get("주문번호") %></a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="/order_admin/orderInfo?order_no=<%=list.get(i).get("주문번호") %>"><%=list.get(i).get("회원명") %></a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="/order_admin/orderInfo?order_no=<%=list.get(i).get("주문번호") %>"><%=list.get(i).get("수취인") %></a>
                                    </td>
                                    <td class="name-pr">
                                    	<a herf="/order_admin/orderInfo?order_no=<%=list.get(i).get("주문번호") %>"><%=list.get(i).get("주문일자") %></a>
                                    </td>
                                    <td class="name-pr">
                                    	<a herf="/order_admin/orderInfo?order_no=<%=list.get(i).get("주문번호") %>"><%=list.get(i).get("주문상태") %></a>
                                    </td>
